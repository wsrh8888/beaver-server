...
func (s *ChatServer) GetMessageSeq(ctx context.Context, in *chat_rpc.GetLatestSeqReq) (*chat_rpc.GetLatestSeqRes, error) {
	l := logic.NewGetMessageSeqLogic(ctx, s.svcCtx)
	return l.GetMessageSeq(in)
}
