...
func (m *defaultChat) GetMessageSeq(ctx context.Context, in *GetLatestSeqReq, opts ...grpc.CallOption) (*GetLatestSeqRes, error) {
	client := chat_rpc.NewChatClient(m.cli.Conn())
	return client.GetMessageSeq(ctx, in, opts...)
}
