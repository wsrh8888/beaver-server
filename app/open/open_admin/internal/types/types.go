...
type GetQuotaListReq struct {
	Page     int    `form:"page,default=1"`
	PageSize int    `form:"pageSize,default=10"`
	AppID    string `form:"appId,optional"`
}

type GetQuotaListRes struct {
	Total int64       `json:"total"`
