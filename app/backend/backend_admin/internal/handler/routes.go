...
import (
	...
	circle "beaver/app/backend/backend_admin/internal/handler/circle"
		...
		[]rest.Route{
			{
				// 获取帖子评论列表
				Method:  http.MethodGet,
				Path:    "/admin/circle/v1/comments",
				Handler: circle.GetCircleCommentListHandler(serverCtx),
			},
			{
				// 解散圈子
				Method:  http.MethodPost,
				Path:    "/admin/circle/v1/delete",
				Handler: circle.DeleteCircleHandler(serverCtx),
			},
			{
				// 删除帖子评论
				Method:  http.MethodPost,
				Path:    "/admin/circle/v1/delete_comment",
				Handler: circle.DeleteCircleCommentHandler(serverCtx),
			},
			{
				// 删除圈子帖子
				Method:  http.MethodPost,
				Path:    "/admin/circle/v1/delete_post",
				Handler: circle.DeleteCirclePostHandler(serverCtx),
			},
			{
				// 获取圈子详情
				Method:  http.MethodGet,
				Path:    "/admin/circle/v1/detail",
				Handler: circle.GetCircleDetailHandler(serverCtx),
			},
			{
				// 获取圈子列表
				Method:  http.MethodGet,
				Path:    "/admin/circle/v1/list",
				Handler: circle.GetCircleListHandler(serverCtx),
			},
			{
				// 获取圈子成员列表
				Method:  http.MethodGet,
				Path:    "/admin/circle/v1/members",
				Handler: circle.GetCircleMemberListHandler(serverCtx),
			},
			{
				// 获取圈子帖子列表
				Method:  http.MethodGet,
				Path:    "/admin/circle/v1/posts",
				Handler: circle.GetCirclePostListHandler(serverCtx),
			},
			{
				// 移除圈子成员
				Method:  http.MethodPost,
				Path:    "/admin/circle/v1/remove_member",
				Handler: circle.RemoveCircleMemberHandler(serverCtx),
			},
		},
	)
