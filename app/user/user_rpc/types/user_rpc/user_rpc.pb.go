...
const file_user_rpc_proto_rawDesc = "" +
	...
	"\rSearchUserRes\x12/\n" +
	"\tuser_info\x18\x01 \x01(\v2\x12.user_rpc.UserInfoR\buserInfo2\xcc\x02\n" +
	"\x04user\x12>\n" +
	"\n" +
...
var file_user_rpc_proto_goTypes = []any{
	...
	nil,                     // 12: user_rpc.UserVersionsRes.UserVersionsEntry
	nil,                     // 13: user_rpc.UserListInfoRes.UserInfoEntry
}
var file_user_rpc_proto_depIdxs = []int32{
	4,  // 0: user_rpc.UserInfoRes.user_info:type_name -> user_rpc.UserInfo
	12, // 1: user_rpc.UserVersionsRes.user_versions:type_name -> user_rpc.UserVersionsRes.UserVersionsEntry
	13, // 2: user_rpc.UserListInfoRes.user_info:type_name -> user_rpc.UserListInfoRes.UserInfoEntry
	...
	1,  // 10: user_rpc.user.UserCreate:output_type -> user_rpc.UserCreateRes
	3,  // 11: user_rpc.user.UserInfo:output_type -> user_rpc.UserInfoRes
	11, // 12: user_rpc.user.SearchUser:output_type -> user_rpc.SearchUserRes
	9,  // 13: user_rpc.user.UserListInfo:output_type -> user_rpc.UserListInfoRes
	7,  // 14: user_rpc.user.UserVersions:output_type -> user_rpc.UserVersionsRes
