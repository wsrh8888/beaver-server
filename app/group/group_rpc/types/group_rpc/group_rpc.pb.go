...
type AddGroupMemberReq struct {
	...
	GroupId       string                 `protobuf:"bytes,1,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	OperatedBy    string                 `protobuf:"bytes,3,opt,name=operated_by,json=operatedBy,proto3" json:"operated_by,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AddGroupMemberRes struct {
	...
	MemberVersion int64                  `protobuf:"varint,2,opt,name=member_version,json=memberVersion,proto3" json:"member_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RemoveGroupMemberRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MemberVersion int64                  `protobuf:"varint,1,opt,name=member_version,json=memberVersion,proto3" json:"member_version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_group_rpc_proto_rawDesc = "" +
	...
	"\x0emember_version\x18\x02 \x01(\x03R\rmemberVersion\"k\n" +
	...
	"\x0emember_version\x18\x01 \x01(\x03R\rmemberVersion2\xbe\a\n" +
	"\x05group\x12O\n" +
	...
	"\x11RemoveGroupMember\x12\x1f.group_rpc.RemoveGroupMemberReq\x1a\x1f.group_rpc.RemoveGroupMemberResB\rZ\v./group_rpcb\x06proto3"
...
var file_group_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
...
var file_group_rpc_proto_depIdxs = []int32{
	...
	19, // 12: group_rpc.group.CanSendGroupMessage:input_type -> group_rpc.CanSendGroupMessageReq
	21, // 13: group_rpc.group.AddGroupMember:input_type -> group_rpc.AddGroupMemberReq
	23, // 14: group_rpc.group.RemoveGroupMember:input_type -> group_rpc.RemoveGroupMemberReq
	2,  // 15: group_rpc.group.GetGroupMembers:output_type -> group_rpc.GetGroupMembersRes
	4,  // 16: group_rpc.group.GetUserGroupMembers:output_type -> group_rpc.GetUserGroupMembersRes
	6,  // 17: group_rpc.group.GetUserGroupIDs:output_type -> group_rpc.GetUserGroupIDsRes
	9,  // 18: group_rpc.group.GetGroupsListByIds:output_type -> group_rpc.GetGroupsListByIdsRes
	12, // 19: group_rpc.group.GetGroupMembersListByIds:output_type -> group_rpc.GetGroupMembersListByIdsRes
	15, // 20: group_rpc.group.GetGroupJoinRequestsListByIds:output_type -> group_rpc.GetGroupJoinRequestsListByIdsRes
	17, // 21: group_rpc.group.GetUserGroupRequestVersions:output_type -> group_rpc.GetUserGroupRequestVersionsRes
	20, // 22: group_rpc.group.CanSendGroupMessage:output_type -> group_rpc.CanSendGroupMessageRes
	22, // 23: group_rpc.group.AddGroupMember:output_type -> group_rpc.AddGroupMemberRes
	24, // 24: group_rpc.group.RemoveGroupMember:output_type -> group_rpc.RemoveGroupMemberRes
