...
type GetFileByMd5Req struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Md5           string                 `protobuf:"bytes,1,opt,name=md5,proto3" json:"md5,omitempty"` // string MD5
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetFileByMd5Res) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFileByMd5Res) ProtoMessage() {}

func (x *GetFileByMd5Res) ProtoReflect() protoreflect.Message {
	mi := &file_file_rpc_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFileByMd5Res.ProtoReflect.Descriptor instead.
func (*GetFileByMd5Res) Descriptor() ([]byte, []int) {
	return file_file_rpc_proto_rawDescGZIP(), []int{10}
}

func (x *GetFileByMd5Res) GetFile() *FileItem {
	if x != nil {
		return x.File
	}
	return nil
...
const file_file_rpc_proto_rawDesc = "" +
	...
	"\x04file\x18\x01 \x01(\v2\x12.file_rpc.FileItemR\x04file\"#\n" +
	"\x0fGetFileByMd5Req\x12\x10\n" +
	"\x03md5\x18\x01 \x01(\tR\x03md5\"9\n" +
	"\x0fGetFileByMd5Res\x12&\n" +
	...
	"\bfile_key\x18\x01 \x01(\tR\afileKey2\xbc\x04\n" +
	"\x04file\x12G\n" +
	...
	"\vGetFileById\x12\x18.file_rpc.GetFileByIdReq\x1a\x18.file_rpc.GetFileByIdRes\x12D\n" +
	"\fGetFileByMd5\x12\x19.file_rpc.GetFileByMd5Req\x1a\x19.file_rpc.GetFileByMd5Res\x12>\n" +
	"\n" +
...
var file_file_rpc_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_file_rpc_proto_goTypes = []any{
	...
	(*GetFileByMd5Req)(nil),        // 9: file_rpc.GetFileByMd5Req
	(*GetFileByMd5Res)(nil),        // 10: file_rpc.GetFileByMd5Res
	(*DeleteFileReq)(nil),          // 11: file_rpc.DeleteFileReq
	(*DeleteFileRes)(nil),          // 12: file_rpc.DeleteFileRes
	(*BatchDeleteFilesReq)(nil),    // 13: file_rpc.BatchDeleteFilesReq
	(*BatchDeleteFilesRes)(nil),    // 14: file_rpc.BatchDeleteFilesRes
	(*SaveFileReq)(nil),            // 15: file_rpc.SaveFileReq
	(*SaveFileRes)(nil),            // 16: file_rpc.SaveFileRes
}
var file_file_rpc_proto_depIdxs = []int32{
	...
	4,  // 2: file_rpc.GetFileByMd5Res.file:type_name -> file_rpc.FileItem
	0,  // 3: file_rpc.file.GetFileDetail:input_type -> file_rpc.GetFileDetailReq
	2,  // 4: file_rpc.file.GetQiniuUploadToken:input_type -> file_rpc.GetQiniuUploadTokenReq
	5,  // 5: file_rpc.file.ListFiles:input_type -> file_rpc.ListFilesReq
	7,  // 6: file_rpc.file.GetFileById:input_type -> file_rpc.GetFileByIdReq
	9,  // 7: file_rpc.file.GetFileByMd5:input_type -> file_rpc.GetFileByMd5Req
	11, // 8: file_rpc.file.DeleteFile:input_type -> file_rpc.DeleteFileReq
	13, // 9: file_rpc.file.BatchDeleteFiles:input_type -> file_rpc.BatchDeleteFilesReq
	15, // 10: file_rpc.file.SaveFile:input_type -> file_rpc.SaveFileReq
	1,  // 11: file_rpc.file.GetFileDetail:output_type -> file_rpc.GetFileDetailRes
	3,  // 12: file_rpc.file.GetQiniuUploadToken:output_type -> file_rpc.GetQiniuUploadTokenRes
	6,  // 13: file_rpc.file.ListFiles:output_type -> file_rpc.ListFilesRes
	8,  // 14: file_rpc.file.GetFileById:output_type -> file_rpc.GetFileByIdRes
	10, // 15: file_rpc.file.GetFileByMd5:output_type -> file_rpc.GetFileByMd5Res
	12, // 16: file_rpc.file.DeleteFile:output_type -> file_rpc.DeleteFileRes
	14, // 17: file_rpc.file.BatchDeleteFiles:output_type -> file_rpc.BatchDeleteFilesRes
	16, // 18: file_rpc.file.SaveFile:output_type -> file_rpc.SaveFileRes
